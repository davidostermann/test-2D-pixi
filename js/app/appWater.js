define([
  ...
  function(Loader) {
    ...
    var renderer, stage, fullWidth, fullHeight, decor, lunettes, imageWidth, imageHeight, displacementFilter;
    var offset = 1;
    ...
    //var displacementSprite = PIXI.TilingSprite.fromImage("img/displacementMap.jpg", 512, 512);
